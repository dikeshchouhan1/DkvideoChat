      ...
      <div className="relative h-screen ">
        ...
        <div className="lg:flex lg:pt-20 flex-col items-center justify-center relative z-10 px-6 md:max-w-[90vw] mx-auto">
          ...
          <div className=" flex flex-col items-center justify-center pb-8">
            ...
            <h1 className="text-[70px] md:text-[90px] text-white font-bold pt-1">
             DK Video Chat App
            </h1>
            <div>

            </div>
            <h5 className="text-[35px] text-white font-bold pt-1  -mt-0">With Dikesh chouhan</h5>
          </div>
          ...
          >
            <div className=" flex flex-col justify-center items-center">
              <label className="text-[30px] md:text-[40px] font-bold pt-1">
                Enter Room Code
              </label>
              <input
                type="text"
